...
/*
Abstract base-class for anything that acts as a source of setting values
*/
...
public:
	...
	none
	*/
	virtual CString getValue(const CString &section, const CString &key, const CString &deflt) const=0;
};
