...
{
	m_hostname = src.getValue("network", "hostname",
		m_hostname);
	m_linkPortNumber = src.getValue("network", "linksPortNumber",
		m_linkPortNumber);
	m_paymentPortNumber = src.getValue("network", "paymentsPortNumber",
		m_paymentPortNumber);
