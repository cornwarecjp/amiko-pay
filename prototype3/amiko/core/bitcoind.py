...
class Bitcoind_Real:
	...
	def handleMessage(self, msg):
		ret = getattr(self.access, msg.command)(*(msg.arguments))
		#TODO: check whether exception handling is OK

		if msg.returnUID is None:
			return []

		return \
			[
			messages.ToUID(UID=msg.returnUID,
				message=messages.BitcoinReturnValue(
					command=msg.command, value=ret
				))
			]
